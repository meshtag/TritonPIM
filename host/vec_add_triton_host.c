// Host-side runner for Triton-generated add_kernel LLVM IR.
#include <dpu.h>
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
...
#ifndef DPU_BINARY
#define DPU_BINARY "./bin/vec_add_triton"
#endif
...
int main(int argc, char **argv) {
  ...
  for (uint32_t i = 0; i < nr_dpus; i++) {
    ...
    args[i].arg0_mram = heap_base32 + a_off;
    args[i].arg1_mram = heap_base32 + b_off;
    args[i].arg2_mram = heap_base32 + c_off;
    args[i].arg3 = n;
  }
  ...
  if (getenv("DPU_DEBUG")) {
    ...
    printf("DBG heap_base=0x%08x args: a=0x%08x b=0x%08x c=0x%08x n=%u\n",
           heap_base32, args_rb.arg0_mram, args_rb.arg1_mram, args_rb.arg2_mram,
           args_rb.arg3);
  }
